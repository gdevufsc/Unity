...
public class carMove : MonoBehaviour
{
    ...
    ///what will the auxiliarVector do?
	...
	void FixedUpdate()
	{
		...
		if (Input.GetMouseButton(0)) {
            ...
            ///if we put it all together would be:
            ///directionAndSpeed = (Input.mousePosition - auxiliarVector).normalized;
            ///directionAndSpeed*= v * Time.fixedDeltaTime;
